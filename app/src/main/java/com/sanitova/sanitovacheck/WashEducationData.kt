...
val washVideos = listOf(
    WashVideo(
        title = "WHO Handwashing Technique",
        source = "Johns Hopkins Medicine / WHO",
        description = "Step-by-step demonstration of the World Health Organization technique for handwashing. Proper hand hygiene is the most important thing you can do to prevent the spread of germs.",
        embedUrl = "https://www.youtube-nocookie.com/embed/IisgnbMfKvI",
    ...
    WashVideo(
        ...
        description = "Official hand hygiene education video demonstrating proper technique for epidemic prevention and infection control.",
        embedUrl = "https://www.youtube-nocookie.com/embed/olE4gaBNX8M",
        watchUrl = "https://www.youtube.com/watch?v=olE4gaBNX8M"
    ),
    WashVideo(
        title = "Cholera — You Can Fight It Too",
        source = "WHO",
        description = "World Health Organization animated video on cholera prevention: recognizing symptoms, treating dehydration with ORS, and stopping transmission through safe water and sanitation.",
        embedUrl = "https://www.youtube-nocookie.com/embed/8-sqticNg5o",
        watchUrl = "https://www.youtube.com/watch?v=8-sqticNg5o"
    ),
    WashVideo(
        title = "The Story of Cholera",
        source = "Global Health Media Project",
        description = "Award-winning animated film showing how cholera spreads and how communities can prevent it — including making oral rehydration solution at home.",
        embedUrl = "https://www.youtube-nocookie.com/embed/jG1VNSCsP5Q",
        watchUrl = "https://www.youtube.com/watch?v=jG1VNSCsP5Q"
    ),
    WashVideo(
        title = "Ending Cholera — A Global Roadmap to 2030",
        source = "Global Task Force on Cholera Control / WHO",
        description = "Official video unveiled at the World Health Assembly celebrating the global commitment to end cholera by 2030 through water, sanitation, and vaccination.",
        embedUrl = "https://www.youtube-nocookie.com/embed/5m3y7Ut-wMs",
        watchUrl = "https://www.youtube.com/watch?v=5m3y7Ut-wMs"
    ),
    WashVideo(
        title = "Safe Water in Remote Communities",
        source = "UNICEF",
        description = "How UNICEF brings safe drinking water to remote and underserved communities worldwide — building infrastructure and training local water managers.",
        embedUrl = "https://www.youtube-nocookie.com/embed/o7KgVBwLEhs",
        watchUrl = "https://www.youtube.com/watch?v=o7KgVBwLEhs"
    ),
    WashVideo(
        title = "Safe Water to Families in Sudan",
        source = "UNICEF",
        description = "A UNICEF-rehabilitated water treatment plant brings clean, safe water to families in Sudan — transforming health and daily life.",
        embedUrl = "https://www.youtube-nocookie.com/embed/k4nuFOpcikw",
        watchUrl = "https://www.youtube.com/watch?v=k4nuFOpcikw"
    ),
    WashVideo(
        title = "Community-Based Total Sanitation",
        source = "SIMASKOTA / SPEAK Indonesia",
        description = "How communities can end open defecation and improve sanitation through local leadership, collective action, and behavior change.",
        embedUrl = "https://www.youtube-nocookie.com/embed/pic4W1AxL2g",
        watchUrl = "https://www.youtube.com/watch?v=pic4W1AxL2g"
    )
)
